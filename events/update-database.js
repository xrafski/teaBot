...
bot.on('ready', () => {  // https://crontab.guru/examples.html
    cron.schedule('0 10 * * *', () => { // run certification update function daily at 10AM CEST
        ...
        certification.certUpdate()
            .then(results => logger('log', `update-database.js:1 () 👉 Certification has been updated`, results.info))
    ...
    setTimeout(() => { // run certification update function at bot startup
        ...
        certification.certUpdate()
            .then(results => logger('log', `update-database.js:3 () 👉 Certification has been updated`, results.info))
    ...
    cron.schedule('0 8 * * *', () => { // run thread update function daily at 8AM CEST
        ...
        blacklist.treadUpdate()
            .then(results => logger('log', `update-database.js:5 () 👉 Thread database has been updated`, results.info))
    ...
    setTimeout(() => { // run tread database function update at bot startup
        ...
        blacklist.treadUpdate()
            .then(results => logger('log', `update-database.js:7 () 👉 Thread database has been updated`, results.info))
