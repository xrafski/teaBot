...
mongoose.connection.on('connecting', () =>
	logger('mongo', 'Handlers/Mongoose.js (1) Connecting to the database.')
);
...
mongoose.connection.on('connected', () =>
	logger('mongo', 'Handlers/Mongoose.js (2) Connected to the database.')
);

// Your app called Connection#close() to disconnect from MongoDB
mongoose.connection.on('disconnecting', () =>
	logger('mongo', 'Handlers/Mongoose.js (3) Disconnecting from the database.')
);
...
mongoose.connection.on('disconnected', () =>
	logger('mongo', 'Handlers/Mongoose.js (4) Disconnected from the database.')
);
...
mongoose.connection.on('close', () =>
	logger('mongo', 'Handlers/Mongoose.js (5) Connection closed.')
);
...
mongoose.connection.on('reconnected', () =>
	logger('mongo', 'Handlers/Mongoose.js (6) Connection restored.')
);
